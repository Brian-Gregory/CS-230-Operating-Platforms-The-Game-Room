...
public class ProgramDriver {
	...
	/**
	 * The one-and-only main() method to start the application.
	 * 
	...
	public static void main(String[] args) {
		...
		// Reuse team names in the same game
		System.out.println("\nReusing team names in the same game");
		...
		// Reuse team names in different games
		System.out.println("\nReusing team names in different games");
		...
		// Reuse player names on the same team
		System.out.println("\nReusing player names on the same team");
		...
		// Reuse player names on different teams
		...
		System.out.println(team4 + " " + player24); // Intentional duplicate?
